...
### Windows
1. Extract the archive to C:\Program Files\CraftCli for all users or C:\Users\\\<You>\AppData\Local\CraftCli for just your user. Make sure the path you chose is on your $PATH (including the CraftCli folder!)
